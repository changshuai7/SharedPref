...
public class SharedPref {
    ...
    public static void removeKey(String key) {
        SharePrefWrapper.removeKey(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key);
    }
    ...
    public static boolean contains(String key) {
        return SharePrefWrapper.contains(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key);
    }

    /// String

    public static void setString(String key, String value) {
        SharePrefWrapper.setString(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, value);
    }
    ...
    public static String getString(String key, String defVal) {
        return SharePrefWrapper.getString(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, defVal);
    }

    public static String getString(String pkgName, String key, String defVal) {
        return SharePrefWrapper.getString(pkgName, SharePrefWrapper.SpName.DEFAULT, key, defVal);
    }
    ...
    public static void setBoolean(String key, boolean value) {
        SharePrefWrapper.setBoolean(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, value);
    }
    ...
    public static boolean getBoolean(String key, boolean defValue) {
        return SharePrefWrapper.getBoolean(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, defValue);
    }
    ...
    public static void setInt(String key, int value) {
        SharePrefWrapper.setInt(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, value);
    }
    ...
    public static int getInt(String key, int defValue) {
        return SharePrefWrapper.getInt(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, defValue);
    }
    ...
    public static void setLong(String key, long value) {
        SharePrefWrapper.setLong(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, value);
    }
    ...
    public static long getLong(String key, long defValue) {
        return SharePrefWrapper.getLong(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, defValue);
    }
    ...
    public static void setFloat(String key, float value) {
        SharePrefWrapper.setFloat(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, value);
    }
    ...
    public static float getFloat(String key, float defValue) {
        return SharePrefWrapper.getFloat(mContext.getPackageName(), SharePrefWrapper.SpName.DEFAULT, key, defValue);
    }
